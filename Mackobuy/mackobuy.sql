...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 15. 19:23
...
INSERT INTO `rendelesek` (`ID`, `FID`, `vegosszeg`, `rendeles_datum`, `szallitasi_dij`, `statusz`) VALUES
(1, 2, 150000, '2025-03-31', 1790, ''),
(2, 3, 9100, '2024-01-20', 1000, ''),
(3, 3, 8000, '2024-02-01', 1200, 'kiszállítva'),
(4, 2, 8000, '2024-02-10', 1300, 'kézbesítve'),
(5, 2, 8000, '2024-02-15', 1400, 'szállítás alatt'),
(6, 2, 1200000, '2025-03-31', 1790, 'feldolgozás alatt'),
(7, 2, 4400000, '2025-03-31', 1790, ''),
(8, 2, 600000, '2025-03-31', 1190, ''),
(9, 2, 150419, '2025-03-31', 1190, ''),
(10, 2, 181419, '2025-04-14', 1190, 'lemondva'),
(11, 3, 101999, '2025-04-15', 1790, ''),
(12, 2, 152019, '2025-04-15', 1790, 'szállítás alatt'),
(13, 2, 152019, '2025-04-15', 1790, 'lemondva'),
(14, 2, 152019, '2025-04-15', 1790, 'feldolgozás alatt'),
(15, 2, 14019, '2025-04-15', 1790, 'feldolgozás alatt');
...
ALTER TABLE `rendeles_tetelek`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `rendeles_id_idx` (`rendeles_id`),
  ADD KEY `termek_id_idx` (`termek_id`);
...
--
ALTER TABLE `rendeles_tetelek`
  ADD CONSTRAINT `fk_rendeles_tetelek_rendeles` FOREIGN KEY (`rendeles_id`) REFERENCES `rendelesek` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_rendeles_tetelek_termek` FOREIGN KEY (`termek_id`) REFERENCES `termekek` (`ID`) ON UPDATE CASCADE;
COMMIT;
