...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top custom-navbar">
            <div class="container">
                <a id="navfooldal" class="navbar-brand" href="mackobuy.php">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Részletek gomb -->
                        <button type="button" class="btn custom-btn kosarbagomb" data-bs-toggle="modal" data-bs-target="#termekModal<?= $termek['ID'] ?>" >
                            Részletek
                        </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer d-flex justify-content-center">
                            <form method="POST" action="kosar.php">
                                ...
                                <button type="submit" class="btn custom-btn kosarbarakasgomb">Kosárba</button>
                            </form>
